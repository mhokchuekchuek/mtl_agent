...
| [💬 **Prompts**](prompts/README.md)<br/>Prompt management with Langfuse | [🗄️ **Data Sources**](data-sources/README.md)<br/>ERP database, product PDFs | [⚙️ **Ingestor**](ingestor/README.md)<br/>PDF ingestion pipeline |
